...
metadata = {
    ...
    "lastModified": "2026-03-04T13:58:55.706Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    pipette_left.transfer_with_liquid_class(
        volume=4,
        source=[tube_rack_1["B2"], tube_rack_1["B2"], tube_rack_1["B2"], tube_rack_1["B2"], tube_rack_1["B2"]],
        dest=[well_plate_1["A3"], well_plate_1["B3"], well_plate_1["A4"], well_plate_1["B4"], well_plate_1["C4"]],
    ...
    pipette_left.transfer_with_liquid_class(
        ...
        dest=[well_plate_1["A5"], well_plate_1["D5"], well_plate_1["A6"], well_plate_1["D6"]],
        new_tip="per destination",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        tip_racks=[tip_rack_1],
